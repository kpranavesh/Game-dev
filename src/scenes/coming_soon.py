...
from src.utils.draw_helpers import draw_cute_face
...
UPCOMING = [
    ("2", "First Date", "Overcooked chaos — don't spill the soup"),
    ("3", "Will You Be Mine?", "Choose every word carefully"),
    ("4", "Squad Approved", "The friend group decides"),
    ("5", "Meet the Family", "Navigate dinner without disaster"),
    ("6", "Moving In + Beans", "Tetris, but make it romantic"),
    ("7", "The Proposal", "Set the perfect scene"),
    ("8", "Plot Twist", "She had a ring too"),
    ("9", "We Do", "Hit every beat"),
    ("10", "Home", "The ending you deserve"),
]
...
class ComingSoonScreen:
    ...
    def draw(self, surface):
        ...
        banner = self.font_big.render("✓ Level 1: Swipe Right — Complete!", True, DARK_BROWN)
